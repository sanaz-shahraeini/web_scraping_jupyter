...
noun = dic_result["name"][code_anime-1]
sa = gspread.service_account(filename="animest-424206-f150a87d1e25.json")
sh = sa.open("Animesp_API")
wks = sh.worksheet("link")
wks.update_acell("A2", noun )
wks.update('B2:D2', [list_link])